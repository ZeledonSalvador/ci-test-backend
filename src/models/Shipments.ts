...
export class Shipments {
  ...
  @OneToMany(() => DataInconsistency, (dataInconsistency) => dataInconsistency.shipment)
  ...
  @OneToMany(() => BlacklistDrivers, (blacklistDrivers) => blacklistDrivers.shipment)
  blacklistDrivers: BlacklistDrivers[];

  @Column({ type: 'decimal', precision: 5, scale: 2, nullable: true, name: 'brix' })
  brix?: number | null;

  @OneToMany(() => Brix, (b) => b.shipment)
  brixLogs: Brix[];

  @Column({ type: 'decimal', precision: 5, scale: 2, nullable: true, name: 'humidity' })
