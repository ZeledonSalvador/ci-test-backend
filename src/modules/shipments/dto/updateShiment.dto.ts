...
} from '../enums/requiresSweepingType.enum';
...
export class UpdateShipmentDto {
  ...
  @IsEnum(ProductType, {
    message: `El tipo de producto debe ser "${buildMessageEnumsWithCode(typeProductMap)}".`,
  })
  @ValidateIf((_, value) => value !== null && value !== undefined)
  ...
  @IsEnum(TipoOperacion, {
    message: `El tipo de operación debe ser "${buildMessageEnumsWithCode(TipoOperacionMap)}".`,
  })
  ...
  @ValidateIf((_, value) => value !== null && value !== undefined)
  @IsEnum(TipoCarga, {
    message: `El tipo de carga debe ser "${buildMessageEnumsWithCode(TipoCargaMap)}".`,
  })
  ...
  @IsEnum(RequiresSweepingType, {
    message: `El require_barrido debe ser "${buildMessageEnumsWithCode(RequiresSweepingMap)}".`,
  })
