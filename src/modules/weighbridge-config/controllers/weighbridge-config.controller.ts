...
export class WeighbridgeConfigController {
  ...
  async createSerialComprobante(@Body() dto: CreateSerialComprobanteDto) {
  ...
  @Roles(Role.ADMIN, Role.BOT)
  async deleteSerialComprobante(@Param('id') id: string) {
  ...
  @Roles(Role.ADMIN, Role.BOT)
  async getNextComprobante(@Query('id_bascula') id_bascula?: string) {
    const basculaId = id_bascula ? Number(id_bascula) : undefined;
    console.log(
      '[Controller] getNextComprobante - id_bascula recibido:',
      id_bascula,
      '-> parseado:',
      basculaId,
    );
  ...
  @Roles(Role.ADMIN, Role.BOT)
  async assignComprobante(@Body() dto: AssignComprobanteDto) {
  ...
  @Roles(Role.ADMIN, Role.BOT)
  async registrarImpresion(@Body() dto: RegistrarImpresionDto) {
  ...
  async cancelComprobante(
    ...
    return this.service.cancelComprobanteByShipmentId(id_shipment, motivo);
  }
  ...
  async cancelComprobanteByNumero(
    ...
    return this.service.cancelComprobanteByNumero(no_comprobante, motivo);
  }
  ...
  @Roles(Role.ADMIN, Role.BOT)
  async deleteSealSeries(@Param('id') id: string) {
  ...
  @Roles(Role.ADMIN, Role.BOT)
  async anularMarchamo(@Body() dto: AnularMarchamoDto) {
