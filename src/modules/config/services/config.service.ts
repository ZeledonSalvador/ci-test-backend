...
export class ConfigService {
    ...
    async getString(key: string, defaultValue: string = ''): Promise<string> {
        ...
        try {
            ...
            this.logger.error(`Error al obtener configuración ${key}: ${error.message}`);
            return defaultValue;
        }
    }
    ...
    async set(key: string, value: string): Promise<void> {
        try {
            ...
            this.logger.error(`Error al actualizar configuración ${key}: ${error.message}`);
            throw error;
        }
    }
    ...
    async getAll(): Promise<SystemConfig[]> {
        ...
        try {
            ...
            this.logger.error(`Error al obtener todas las configuraciones: ${error.message}`);
            return [];
        }
    }
