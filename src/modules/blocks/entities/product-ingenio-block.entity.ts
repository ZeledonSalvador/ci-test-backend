...
@Entity({ name: 'ProductIngenioBlock', schema: 'dbo' }) // si tu tabla es snake_case: { name: 'product_ingenio_blocks', schema: 'dbo' }
@Unique('UQ_ProductIngenioBlock_pair', ['ingenioCode', 'productCode'])
export class ProductIngenioBlock {
  @PrimaryGeneratedColumn()
  id: number; // INT IDENTITY(1,1) PRIMARY KEY
