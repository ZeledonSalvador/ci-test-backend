...
export class InconsistencyResponseDto {
    ...
    constructor(dataInconsistency: DataInconsistency) {
        ...
        this.shipmentData = {
            ...
            shipmentSeals: dataInconsistency.shipment.shipmentSeals?.map(seal => ({
        ...
        try {
            this.parsedInconsistencyData = JSON.parse(dataInconsistency.inconsistencyType);
        } catch (error) {
...
export class InconsistencyListResponseDto {
    ...
    constructor(data: InconsistencyResponseDto[], total: number, page: number, size: number) {
        this.data = data;
        this.total = total;
        this.page = page;
        this.size = size;
