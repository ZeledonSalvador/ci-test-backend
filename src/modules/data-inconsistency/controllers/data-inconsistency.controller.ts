...
export class DataInconsistencyController {
    ...
    async getInconsistenciesByIngenio(
        ...
        console.log(`Obteniendo inconsistencias del ingenio: ${ingenioCode} - Página: ${page}, Tamaño: ${size}${query.startDate ? `, Fechas: ${query.startDate} - ${query.endDate}` : ''}`);
        
        const result = await this.dataInconsistencyService.getInconsistenciesByIngenio(ingenioCode, page, size, query);
    ...
    async getInconsistenciesByIngenioNav(
        ...
        console.log(`Obteniendo inconsistencias del ingenio (ingenioNavCode): ${ingenioNavCode} - Página: ${page}, Tamaño: ${size}${query.startDate ? `, Fechas: ${query.startDate} - ${query.endDate}` : ''}`);
        
        const result = await this.dataInconsistencyService.getInconsistenciesByIngenioNav(ingenioNavCode, page, size, query);
    ...
    async getInconsistenciesStatsByIngenioNav(
        ...
        console.log(`Obteniendo estadísticas del ingenio (ingenioNavCode): ${ingenioNavCode}`);
        
        return await this.dataInconsistencyService.getInconsistenciesStatsByIngenioNav(ingenioNavCode, query);
    }
    ...
    async getAllInconsistencies(
        ...
        const result = await this.dataInconsistencyService.getAllInconsistencies(page, size, query);
