...
describe('InternalPermissions Decorator', () => {
  it('should create metadata decorator with single permission', () => {
    ...
    decorator(TestClass.prototype, 'testMethod', Object.getOwnPropertyDescriptor(TestClass.prototype, 'testMethod')!);
    
    const metadata = Reflect.getMetadata('internal-permissions', TestClass.prototype.testMethod);
